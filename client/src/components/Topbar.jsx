...
const Topbar = () => {
  ...
  return (
    <div className="fixed z-20 flex h-16 w-full items-center justify-between border-b bg-white px-5">
      <button
        onClick={toggleSidebar}
        type="button"
        className="mr-3 block sm:hidden"
      >
      ...
      <div className="w-125">
        <div
          className={`absolute top-15 left-0 w-full bg-white px-5 sm:relative sm:top-0 sm:block sm:px-0 ${showSearch ? "block" : "hidden"}`}
        >
          <SearchBox />
        </div>
      </div>
