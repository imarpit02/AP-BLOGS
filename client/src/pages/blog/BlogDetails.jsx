              ...
              <TableBody>
                {blogData?.blog?.length > 0 ? (
                  blogData.blog.map((blog) => (
                    ...
                    >
                      {/* Author */}
                      <TableCell className="">{blog?.author?.name}</TableCell>
                      {/* Category Name */}
                      <TableCell className="">{blog?.category?.name}</TableCell>
                      {/* Title */}
                      <TableCell className="wrap-break-words max-w-62.5 whitespace-normal">
                        {blog?.title}
                      </TableCell>
                      {/* Slug */}
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={6}
                      className="mx-auto h-60 text-center text-xl text-gray-500"
                    >
                      Data not found
                    </TableCell>
                  </TableRow>
