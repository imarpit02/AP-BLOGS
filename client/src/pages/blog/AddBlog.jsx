                ...
                <Dropzone onDrop={acceptedFiles => handleFileSelection(acceptedFiles)}>
                  {({ getRootProps, getInputProps }) => (
                    <div {...getRootProps()} className='inline-block'>
                      <input {...getInputProps()} />
                      <div className='relative h-16 w-32 border-2 border-dashed mt-2 flex items-center justify-center cursor-pointer hover:bg-gray-50'>
                        {filePreview ? (
                          <img src={filePreview} alt="" className='w-full h-full object-cover p-1' />
                        ) : (
                          <span className='text-gray-400 text-4xl leading-none'>+</span>
                        )}
                      </div>
                    </div>
                  )}
