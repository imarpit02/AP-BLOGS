...
const Profile = () => {
  ...
  return (
    <Card className="max-w-2xl mx-auto">
            ...
            {({ getRootProps, getInputProps }) => (
              <div {...getRootProps()}>
                ...
                <Avatar className="h-20 w-20 relative group">
                  ...
                  <div className='h-full w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 group-hover:flex items-center justify-center bg-black/20 rounded-full border-2 border-primary hidden cursor-pointer'>
      ...
      <CardFooter>
        <Button type="submit" form="update-profile-form" className="h-11 w-full" disabled = {uploading}>
